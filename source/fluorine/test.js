...
console.log(process)
console.log("# Execute one step in the Process instance, with a parameter.")
console.log(process.run("Hello"))
console.log("# Execute one step of the process with a result from previous step.")
console.log(process.run("World"))
